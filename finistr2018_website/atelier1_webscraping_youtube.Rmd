---
title: "Scraping Youtube"
author: "Avner Bar-Hen, Gabriel Lang, Raphaëlle Momal,Bewentaoré Sawadogo "
date: "August 27, 2018"
output: 
  html_document:
   toc: true
...
```
## Récolter des données sur Youtube

L'objectif est de récupérer la liste des tendances de Youtube qui se trouvent dans la page. Pour cela on se sert du package rvest et de la sélection par balises.
...
<!-- #Récolte d'une information par une balise connue -->
...
<!-- #Récolte d'une information lorsque la balise n'est pas connue -->
